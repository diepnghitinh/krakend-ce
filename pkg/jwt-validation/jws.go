...
const (
	ValidatorNamespace = "github.com/krakendio/krakend-ce/v2/pkg/jwt-validation/validator"
	//Using for internal
	SignerNamespace = "github.com/krakendio/krakend-ce/v2/pkg/jwt-validation/signer"
